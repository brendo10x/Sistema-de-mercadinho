 ...
 */
	...
	//explicação do código  destas duas funções
	// http://bakery.cakephp.org/articles/view/4cb129eb-e228-4b6d-bc97-4cdfd13e7814/lang:por

	//criptografa
	public function encrypt($data) { 
        if ($data !== '') { 
            return base64_encode(mcrypt_encrypt(Configure::read('Cryptable.cipher'), Configure::read('Cryptable.key'), $data, 'ecb', Configure::read('Cryptable.iv')));
        } else { 
            return ''; 
        } 
    } 
    ...
    public function decrypt($data) { 
        ...
        if ($data != '') { 
            return trim(mcrypt_decrypt(Configure::read('Cryptable.cipher'), Configure::read('Cryptable.key'), base64_decode($data), 'ecb', Configure::read('Cryptable.iv')));
        } else { 
            return ''; 
        } 
    } 
