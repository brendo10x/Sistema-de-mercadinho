...
<div id="main-content">
    ...
    <div class="container-fluid">
        ...
        <form id="formDados" action="<?php echo $this -> Html -> url(array("controller" => "vendedores", "action" => "novo")); ?>" enctype="multipart/form-data" method="post">
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            ...
                            <div action="#" class="form-horizontal" >
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input minlength="14" maxlength="14" required="required"  type="text" name="data[Pessoa][pes_cpf_ou_cnpj]" class="span5"   />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" required="required" name="data[Vendedor][ven_rg]" class="span5"    />
            ...
            <div class="row-fluid">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input   name="data[Usuario][email]" type="email" required="required" class="span5" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="data[Usuario][senha]" minlength="3" required="required" id="senha"  type="password" class="span5 " />
                                </div>
                            </div>

                            <div class="control-group">
                                <label class="control-label"><?php echo __('Confirme Senha') ?>: </label>
                                <div class="controls">
                                    <input   equalTo="#senha"   type="password" class="span5"  />
                ...
                <input type="hidden" name="data[Vendedor][usuario_id]" />
                <input type="hidden" name="data[Vendedor][endereco_id]" />
                <input type="hidden" name="data[Vendedor][pessoa_id]" />
...
<script type="text/javascript">
    ...
    $.validator.addMethod("emailSeExiste", function(value, element, param) {
        ...
        var result = ajaxEmailSeExiste(element);
    ...
    $("#formDados").validate({
     ...
     <?php echo $this -> element('validatorOpcoes'); ?>,
                                ...
                                function ajaxEmailSeExiste(element) {

                                var result = $.ajax({
                                type: "POST",
                                url: '<?php echo $this -> Html -> url('/'); ?>usuarios/verificaEmail',
                                    data: 'data[email]=' + element.value,
                                    async: false,
                                    global: false,
                                    }).responseText;
