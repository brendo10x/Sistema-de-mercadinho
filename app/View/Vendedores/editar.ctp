...
<div id="main-content">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li> <a href="<?php echo $this -> Html -> url(array("controller" => "vendedores", "action" => "listar")); ?>"><?php  echo __('Listar vendedores') ?></a><span class="divider">&nbsp;</span> </li>
        ...
        <form id="formDados" action="<?php echo $this -> Html -> url(array("controller" => "vendedores", "action" => "editar")); ?>" enctype="multipart/form-data" method="post">
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                                                            ...
                                                            <div class="widget">
                                                                ...
                                                                <div class="widget-body">
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <div class="fileupload fileupload-<?php (!empty($vendedor['Pessoa']['pes_foto'])) ? print "exists" : print "new"; ?>" data-provides="fileupload">

                                                                                <div class="fileupload-new thumbnail" style="width: 100px; height: 100px;">

                                                                                    <img src="<?php echo $this -> Html -> url('/img/photo.jpg'); ?>" alt="" /> </div>
                                                                                    <div  class="fileupload-preview fileupload-exists thumbnail"  style="max-width: 200px; max-height: 150px; line-height: 20px;" >
                                                                                       <img src="<?php echo $this->Html->url('/img/') ?><?php echo $vendedor['Pessoa']['pes_foto'] ?>" alt="" />
                                                                                   </div>
...
<!-- fim tab_1_2--> 
                                                 <!--Script foto webcam--> 
                                                <?php echo $this -> element('webcam',array('cache' => true)); ?>
...
<div class="control-group">
    ...
    <div class="controls ">
        <input type="text"  minlength="2" required="required" value="<?php echo $vendedor['Pessoa']['pes_nome']  ?>" name="data[Pessoa][pes_nome]" class="span8"  />
...
<div class="control-group ">
    ...
    <div class="controls">
        <select class="span5" name="data[Pessoa][pes_sexo]">
            <option <?php ($vendedor['Pessoa']['pes_sexo'] == 0) ? print ' selected="selected" ' : print ''; ?> value="0"><?php echo __('Masculino') ?></option>
            <option <?php ($vendedor['Pessoa']['pes_sexo'] == 1) ? print ' selected="selected" ' : print ''; ?>  value="1"><?php echo __('Feminino') ?></option>
        </select>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" minlength="14" maxlength="14" required="required"  value="<?php echo $vendedor['Pessoa']['pes_cpf_ou_cnpj'] ?>" name="data[Pessoa][pes_cpf_ou_cnpj]" class="span5"   />
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" required="required" value="<?php echo $vendedor['Pessoa']['pes_telefone'] ?>"  name="data[Pessoa][pes_telefone]" class="span5"  data-mask="(99)9999-9999" placeholder=""   />
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" required="required" value="<?php echo $vendedor['Vendedor']['ven_rg'] ?>"  name="data[Vendedor][ven_rg]" class="span5"  />
                ...
                <div class="widget-body form">
                    <div class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required="required" value="<?php echo $vendedor['Endereco']['end_rua'] ?>"  name="data[Endereco][end_rua]"  class="span5"    />
                            </div>
                        </div>  
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required="required" value="<?php echo $vendedor['Endereco']['end_numero'] ?>" name="data[Endereco][end_numero]"   class="span5"    />
                            </div>
                        </div>  
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required="required" value="<?php echo $vendedor['Endereco']['end_bairro'] ?>"  name="data[Endereco][end_bairro]"   class="span5" />
                            </div>
                        </div>
    ...
    <div class="controls"> <span class="carregando" style="display: none;">
        ...
        <select required="required" class="span5" name="data[Endereco][cidade_id]" id="cod_cidades">
            ...
            foreach ($listaCidades['Cidade'] as $key => $value) {
                ...
                <option <?php ($value['id'] == $vendedor['Endereco']['cidade_id']) ? print ' selected="selected" ' : print ''; ?> value="<?php echo $value['id'] ?>"><?php echo $value['cid_nome']; ?></option>        
...
<div class="row-fluid">
    <div class="span12">
            ...
            <div class="widget-title">
                ...
                <div class="widget-body form">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="data[Usuario][email]" required="required" value="<?php echo $vendedor['Usuario']['email']  ?>"  type="email" class="span5" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="data[Usuario][senha]"  value="<?php echo $vendedor['Usuario']['senha'] ?>"  type="password" class="span5 tooltips" data-trigger="hover" minlength="3"  required="required" data-original-title="<?php echo __('Sua senha é').' : '. $vendedor['Usuario']['senha'] ?>" />
                   ...
                   <input type="hidden" name="data[Usuario][tipo]" value="1" />
       ...
       <input type="hidden" name="data[Vendedor][id]" value="<?php echo $vendedor['Vendedor']['id']; ?>" />
       <input type="hidden" name="data[Pessoa][id]" value="<?php echo $vendedor['Pessoa']['id']; ?>" />  
       <input type="hidden" name="data[Usuario][id]" value="<?php echo $vendedor['Usuario']['id']; ?>" />
       <input type="hidden" name="data[Endereco][id]" value="<?php echo $vendedor['Vendedor']['endereco_id']; ?>" />  

       <!-- envio as dependências-->
       <input type="hidden" name="data[Pessoa][pes_foto]" value="<?php echo $vendedor['Pessoa']['pes_foto']; ?>" />          
...
<script type="text/javascript">
 ...
 $.validator.addMethod("emailSeExiste",function(value,element,param){
    ...
    var result = ajaxEmailSeExiste(element,<?php echo $vendedor['Usuario']['id']; ?>); 
 ...
 $.validator.addMethod("CPFouCNPJseExiste",function(value,element,param){
    ...
    var result = ajaxCPFouCNPJSeExiste(element,<?php echo $vendedor['Pessoa']['id']; ?>); 
