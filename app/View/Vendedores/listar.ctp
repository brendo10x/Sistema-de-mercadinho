                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="dataTables_wrapper form-inline" role="grid">
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <form id="formDados" action="<?php echo $this->Html->url(array("controller" => "vendedores", "action" => "listar", "buscar")); ?>" method="post">
                            ...
                            <form id="excluir_selecionados"  action="<?php echo $this->Html->url(array("controller" => "vendedores", "action" => "excluir_selecionados")); ?>" method="post">
                                        ...
                                        <?php foreach ($vendedores as $key => $value) { ?>
                                            <tr class="gradeX odd">
                                                <td>
                                                    ...
                                                    <input id="check_box_<?php echo $value['Vendedor']['id'] ?>" 
                                                           name="data[<?php echo $key ?>]" value="<?php echo $value['Vendedor']['id'] ?>" class="css-checkbox" type="checkbox" />
                                                    <label for="check_box_<?php echo $value['Vendedor']['id'] ?>" name="check_box_<?php echo $value['Vendedor']['id'] ?>" class="css-label">
                                                    </label>
                                                ...
                                                <td><div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li> <a class="botaoVisualizar" id="id-visualizar-<?php echo $value['Vendedor']['id'] ?>" href="#modal<?php echo $value['Vendedor']['id'] ?>" role="button"  data-toggle="modal"> <i class="icon-eye-open"></i><?php echo __('Visualizar') ?></a> </li>
                                                            <li> 
                                                                <a href="<?php echo $this->Html->url(array("controller" => "vendedores", "action" => "editar", $value['Vendedor']['id'])); ?>">
                                                                    <i class="icon-edit"></i><?php echo __('Atualizar') ?></a> </li>
                                                            <li> <a id="id-excluir-<?php echo $value['Vendedor']['id'] ?>" class="botaoExcluir" href="#"> <i class="icon-trash"></i><?php echo __('Excluir') ?></a> </li>
                                                            <li class="divider"></li>
                                                            <li> <a href="<?php echo $this->Html->url(array("controller" => "vendedores", "action" => "novo")); ?>"> <i class="icon-plus"></i><?php echo __('Adicionar') ?></a> </li>
                                            ...
                                            <!--Informações modal-->
                                        <div id="modal<?php echo $value['Vendedor']['id'] ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $value['Vendedor']['id'] ?>" aria-hidden="true"> </div>
...
<!--Visualizar -->
<?php echo $this->element('scriptVisualizar', array("controle" => "vendedores")); ?>

<!--http://bootboxjs.com/documentation.html--> 
<!--Ação de excluir um único registro com caixa de diálogo--> 
<?php echo $this->element('scriptExcluir', array("controle" => "vendedores")); ?>
