...
<div id="main-content"> 
  ...
  <div class="row-fluid">
    <div class="span12">
      ...
      <ul class="breadcrumb">
        ...
        <li> <a href="<?php echo $this->Html->url(array("controller" => "clientes", "action" => "listar")); ?>">
          <?php  echo __('Listar clientes') ?>
  ...
  <?php } ?>
  <form id="formDados" action="<?php echo $this->Html->url(array("controller" => "clientes", "action" => "editar")); ?>" enctype="multipart/form-data" method="post">
    <div class="row-fluid">
      <div class="span12">
        <div class="widget">
          ...
          <div class="widget-body form">
            <div style="display:none" class="alert alert-error">
              ...
              <strong><?php echo __('Atenção') ?>!</strong> <span id="infoAlerta"></span>. </div>
            <div action="#" class="form-horizontal" >
                          ...
                          <div class="widget">
                            ...
                            <div class="widget-body">
                              <div class="control-group">
                                ...
                                <div class="controls">
                                  <div class="fileupload fileupload-<?php (!empty($cliente['Pessoa']['pes_foto'])) ? print "exists"  : print "new"; ?>" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 100px; height: 100px;"> <img src="<?php echo $this->Html->url('/img/photo.jpg'); ?>" alt="" /> </div>
                                    <div  class="fileupload-preview fileupload-exists thumbnail"  style="max-width: 200px; max-height: 150px; line-height: 20px;" > <img src="<?php echo $this->Html->url('/img/') ?><?php echo $cliente['Pessoa']['pes_foto'] ?>" alt="" /> </div>
                              ...
                              <h6>
                                ...
                                <?php echo __('Escolha uma foto com extensão .PNG ou .JPEG/JPG') ?>! </h6>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="span6">
                          <div class="widget">
                            ...
                            <div class="widget-body">
                              ...
                              <span id="carregandoInfoWebcam" ><img src="<?php echo $this->Html->url('/'); ?>/assets/pre-loader/Fading squares.gif" alt="Fading squares"></span> </div>
                          </div>
                        </div>
              ...
              <div class="control-group">
                ...
                <div class="controls ">
                  <input type="text" minlength="2" required="required" value="<?php echo $cliente['Pessoa']['pes_nome']  ?>" name="data[Pessoa][pes_nome]" class="span8"  />
                </div>
              </div>
              <div class="control-group ">
                ...
                <div class="controls">
                  <select class="span5" name="data[Pessoa][pes_sexo]">
                    <option <?php ($cliente['Pessoa']['pes_sexo'] == 0) ? print ' selected="selected" '  : print ''; ?> value="0"><?php echo __('Masculino') ?></option>
                    <option <?php ($cliente['Pessoa']['pes_sexo'] == 1) ? print ' selected="selected" '  : print ''; ?>  value="1"><?php echo __('Feminino') ?></option>
                  </select>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" minlength="14" maxlength="14" required="required"  value="<?php echo $cliente['Pessoa']['pes_cpf_ou_cnpj'] ?>" name="data[Pessoa][pes_cpf_ou_cnpj]" class="span5"  />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label"><?php echo __('Telefone') ?>: </label>
                <div class="controls">
                  <input type="text" required="required"  value="<?php echo $cliente['Pessoa']['pes_telefone'] ?>"  name="data[Pessoa][pes_telefone]" class="span5"  data-mask="(99)9999-9999"    />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Email:</label>
                <div class="controls">
                  <input name="data[Cliente][email]" type="email" required="required" class="span5" value="<?php echo $cliente['Cliente']['email'] ?>" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row-fluid">
          ...
          <div class="widget-body form">
            <div class="form-horizontal">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" required="required" value="<?php echo $cliente['Endereco']['end_rua'] ?>"  name="data[Endereco][end_rua]"  class="span5"    />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label"><?php echo __('Número') ?>: </label>
                <div class="controls">
                  <input type="text" required="required" value="<?php echo $cliente['Endereco']['end_numero'] ?>" name="data[Endereco][end_numero]"   class="span5"    />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label"><?php echo __('Bairro') ?>: </label>
                <div class="controls">
                  <input type="text" required="required" value="<?php echo $cliente['Endereco']['end_bairro'] ?>"  name="data[Endereco][end_bairro]"   class="span5" />
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls"> <span class="carregando" style="display: none;"> <img src="<?php echo $this->Html->url('/'); ?>/assets/pre-loader/Fading squares.gif" alt="Fading squares"></span>
                ...
                ?>
                    <option <?php ($value['id'] == $cliente['Endereco']['cidade_id']) ? print ' selected="selected" '  : print ''; ?> value="<?php echo $value['id'] ?>"><?php echo $value['cid_nome']; ?></option>
                    <?php }  ?>
                  </select>
                </div>
              </div>
      ...
      <input type="hidden" name="data[Pessoa][id]" value="<?php echo $cliente['Pessoa']['id'];  ?>" />
      <input type="hidden" name="data[Endereco][id]" value="<?php echo $cliente['Cliente']['endereco_id'];  ?>" />
      <input type="hidden" name="data[Pessoa][pes_foto]" value="<?php echo $cliente['Pessoa']['pes_foto'];  ?>" />
    </div>
    </div>
  </form>
  <!--fim formulário--> 
...
<?php echo $this -> Html -> script('jquery.validate'); ?> <?php echo $this->Html->script('jquery.validate.msg-'.$usuario['Config']['idioma']); ?> 
<script type="text/javascript">
 ...
 $.validator.addMethod("CPFouCNPJseExiste",function(value,element,param){
    ...
    var result = ajaxCPFouCNPJSeExiste(element,<?php echo $cliente['Pessoa']['id']; ?>); 
