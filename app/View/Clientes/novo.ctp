...
<div id="main-content">
    ...
    <div class="container-fluid">
        ...
        <form id="formDados" action="<?php echo $this->Html->url(array("controller" => "clientes", "action" => "novo")); ?>" enctype="multipart/form-data" method="post">
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            ...
                            <div action="#" class="form-horizontal" >
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  required="required"  name="data[Pessoa][pes_telefone]" class="span5"  data-mask="(99)9999-9999"  />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                         <input type="email" required="required" name="data[Cliente][email]" required="required" class="span5" />
                                    </div>
                                </div>
            ...
            <div class="row-fluid">
                ...
                <input type="hidden" name="data[Cliente][endereco_id]" />
                <input type="hidden" name="data[Cliente][pessoa_id]" />
...
<script type="text/javascript">
    ...
    $("#formDados").validate({
        ...
        //evento acionado quando enviar o formulário
