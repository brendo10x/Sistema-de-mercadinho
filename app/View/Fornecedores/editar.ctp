...
<div id="main-content">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li> <a href="<?php echo $this->Html->url(array("controller" => "fornecedores", "action" => "listar")); ?>"><?php  echo __('Listar fornecedores') ?></a><span class="divider">&nbsp;</span> </li>
        ...
        <form id="formDados" action="<?php echo $this->Html->url(array("controller" => "fornecedores", "action" => "editar")); ?>" enctype="multipart/form-data" method="post">
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                                                            ...
                                                            <div class="widget">
                                                                ...
                                                                <div class="widget-body">
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <div class="fileupload fileupload-<?php (!empty($fornecedor['Pessoa']['pes_foto'])) ? print "exists"  : print "new"; ?>" data-provides="fileupload">

                                                                                <div class="fileupload-new thumbnail" style="width: 100px; height: 100px;">

                                                                                    <img src="<?php echo $this->Html->url('/img/photo.jpg'); ?>" alt="" /> </div>
                                                                                    <div  class="fileupload-preview fileupload-exists thumbnail"  style="max-width: 200px; max-height: 150px; line-height: 20px;" >
                                                                                     <img src="<?php echo $this->Html->url('/img/') ?><?php echo $fornecedor['Pessoa']['pes_foto'] ?>" alt="" />
                                                                                 </div>
...
<div class="control-group">
    ...
    <div class="controls ">
        <input type="text" minlength="2" required="required" value="<?php echo $fornecedor['Pessoa']['pes_nome']  ?>" name="data[Pessoa][pes_nome]" class="span8"  />
...
<div class="control-group ">
    ...
    <div class="controls">
        <select class="span5" name="data[Pessoa][pes_sexo]">
            <option <?php ($fornecedor['Pessoa']['pes_sexo'] == 0) ? print ' selected="selected" '  : print ''; ?> value="0"><?php echo __('Masculino') ?></option>
            <option <?php ($fornecedor['Pessoa']['pes_sexo'] == 1) ? print ' selected="selected" '  : print ''; ?>  value="1"><?php echo __('Feminino') ?></option>
        </select>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" maxlength="18" required="required"   minlength="18" value="<?php echo $fornecedor['Pessoa']['pes_cpf_ou_cnpj'] ?>" name="data[Pessoa][pes_cpf_ou_cnpj]" class="span5"   />
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" required="required" value="<?php echo $fornecedor['Pessoa']['pes_telefone'] ?>"  name="data[Pessoa][pes_telefone]" class="span5"  data-mask="(99)9999-9999" placeholder=""   />
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <textarea name="data[Fornecedor][observacoes]" required="required" class="span8" rows="3"><?php echo $fornecedor['Fornecedor']['observacoes'] ?></textarea>
    </div>
</div>
                ...
                <div class="widget-body form">
                    <div class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required="required" value="<?php echo $fornecedor['Endereco']['end_rua'] ?>"  name="data[Endereco][end_rua]"  class="span5"    />
                            </div>
                        </div>  
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required="required" value="<?php echo $fornecedor['Endereco']['end_numero'] ?>" name="data[Endereco][end_numero]"   class="span5"    />
                            </div>
                        </div>  
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" required="required" value="<?php echo $fornecedor['Endereco']['end_bairro'] ?>"  name="data[Endereco][end_bairro]"   class="span5" />
                            </div>
                        </div>
    ...
    <div class="controls"> <span class="carregando" style="display: none;">
        ...
        <select required="required" class="span5" name="data[Endereco][cidade_id]" id="cod_cidades">
            ...
            foreach ($listaCidades['Cidade'] as $key => $value) {
                ...
                <option <?php ($value['id'] == $fornecedor['Endereco']['cidade_id']) ? print ' selected="selected" '  : print ''; ?> value="<?php echo $value['id'] ?>"><?php echo $value['cid_nome']; ?></option>        
...
<input type="hidden" name="data[Fornecedor][id]" value="<?php echo $fornecedor['Fornecedor']['id'];  ?>" />
<input type="hidden" name="data[Pessoa][id]" value="<?php echo $fornecedor['Pessoa']['id'];  ?>" />  
<input type="hidden" name="data[Endereco][id]" value="<?php echo $fornecedor['Fornecedor']['endereco_id'];  ?>" />  
<input type="hidden" name="data[Pessoa][pes_foto]" value="<?php echo $fornecedor['Pessoa']['pes_foto'];  ?>" /> 
...
<script type="text/javascript">
 ...
 $.validator.addMethod("CPFouCNPJseExiste",function(value,element,param){
    ...
    var result = ajaxCPFouCNPJSeExiste(element,<?php echo $fornecedor['Pessoa']['id']; ?>); 
