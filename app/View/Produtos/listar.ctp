                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="dataTables_wrapper form-inline" role="grid">
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    <form id="formDados" action="<?php echo $this->Html->url(array("controller" => "Produtos", "action" => "listar", "buscar")); ?>" method="post">
                                        ...
                                        <?php foreach ($produtos as $key => $value) { ?>
                                            <tr class="gradeX odd">
                                                <td>
                                                    ...
                                                    <input id="check_box_<?php echo $value['Produto']['id'] ?>" 
                                                           name="data[<?php echo $key ?>]" value="<?php echo $value['Produto']['id'] ?>" class="css-checkbox" type="checkbox" />
                                                    <label for="check_box_<?php echo $value['Produto']['id'] ?>" name="check_box_<?php echo $value['Produto']['id'] ?>" class="css-label">
                                                    </label>
                                                ...
                                                <td><div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li> <a class="botaoVisualizar" id="id-visualizar-<?php echo $value['Produto']['id'] ?>" href="#modal<?php echo $value['Produto']['id'] ?>" role="button"  data-toggle="modal"> <i class="icon-eye-open"></i><?php echo __('Visualizar') ?></a> </li>
                                                            <li> 
                                                                <a href="<?php echo $this->Html->url(array("controller" => "Produtos", "action" => "editar", $value['Produto']['id'])); ?>">
                                                                    <i class="icon-edit"></i><?php echo __('Atualizar') ?></a> </li>
                                                            <li> <a id="id-excluir-<?php echo $value['Produto']['id'] ?>" class="botaoExcluir" href="#"> <i class="icon-trash"></i><?php echo __('Excluir') ?></a> </li>
                                                            <li class="divider"></li>
                                                            <li> <a href="<?php echo $this->Html->url(array("controller" => "Produtos", "action" => "novo")); ?>"> <i class="icon-plus"></i><?php echo __('Adicionar') ?></a> </li>
...
<?php echo $this->element('scriptExcluir', array("controle" => "produtos")); ?>
