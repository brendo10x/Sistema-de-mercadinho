...
/**
 * Application wide charset encoding - PARA CARACTERES ESPECIAIS  ISO-8859-1 ou UTF-8'
 */
 ...
 */
Configure::write('Security.salt', 'DYhG93b0qyJfIxfed2uVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '76859309657451142496749683645');


// achei aqui http://bakery.cakephp.org/articles/view/4cb129eb-e228-4b6d-bc97-4cdfd13e7814/lang:por
// e adicionei no arquivo (Security.php) 2 funções uma de criptografar / descriptografar
Configure::write('Cryptable.cipher', 'rijndael-192'); 
Configure::write('Cryptable.key','1233'); 
Configure::write('Cryptable.iv', base64_decode('1233a')); // Create with mcrypt_create_iv with the appropriate size for your cipher
